...
<html lang="en">
    <head>
        ...
        <title>UiTM Club Activities Approval System - FAQs</title>
    ...
    <body>
        ...
        <div class="px-5 py-4">
            <h4 style="text-align: justify; text-justify: inter-word;">Frequently Asked Questions can be found here.</h4>
        </div>
