        ...
        if(!is_bool($appRes)){
            ...
            foreach($appArr as $currApp){
                ...
                if($currApp[4] == NULL){
                    ...
                    array_push($outputRowData, '<button class="btn btn-primary" style="display: block;" id="viewAppButton">Review Application</button>');
                } else {
                    if($currApp[4]){
                    ...
                    array_push($outputRowData, '<button class="btn btn-primary" style="display: block;" id="viewAppButton" data-bs-toggle="tooltip" data-bs-placement="top" title="Already Reviewed" disabled>Application Reviewed</button>');
                }
